# MyBatis 数据库 | ruoyi-vue-pro 开发指南
...
- [1. 实体类](#1-实体类)
  ...
  - [1.2 逻辑删除](#12-逻辑删除)
  - [1.3 自动填充](#13-自动填充)
  - [1.4 “复杂”字段类型](#14-复杂字段类型)
- [2. 编码规范](#2-编码规范)
- [3. CRUD 接口](#3-crud-接口)
  - [3.1 selectOne](#31-selectone)
  - [3.2 selectCount](#32-selectcount)
  - [3.3 selectList](#33-selectlist)
  - [3.4 selectPage](#34-selectpage)
  - [3.5 insertBatch](#35-insertbatch)
- [4. 批量插入](#4-批量插入)
- [5. 条件构造器](#5-条件构造器)
...
**原文链接**: https://doc.iocoder.cn/mybatis/

**所属章节**: 后端手册

**爬取时间**: 2026/3/3 15:02:36
...
![](https://doc.iocoder.cn/img/%E6%95%B0%E6%8D%AE%E5%BA%93MyBatis/05.png)

正确

![](https://doc.iocoder.cn/img/%E6%95%B0%E6%8D%AE%E5%BA%93MyBatis/06.png)
...
具体的使用示例，可见 [TenantMapper (opens new window)](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-system/src/main/java/cn/iocoder/yudao/module/system/dal/mysql/tenant/TenantMapper.java) 类中，定义 selectPage 查询方法。代码如下：
