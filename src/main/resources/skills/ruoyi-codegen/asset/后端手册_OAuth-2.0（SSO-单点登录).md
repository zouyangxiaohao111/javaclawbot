# OAuth 2.0（SSO 单点登录) | ruoyi-vue-pro 开发指南
...
- [OAuth 2.0 是什么？](#oauth-20-是什么)
- [OAuth 2.0 授权模式的选择？](#oauth-20-授权模式的选择)
- [OAuth 2.0 技术选型？](#oauth-20-技术选型)
- [如何实现 SSO 单点登录？](#如何实现-sso-单点登录)
  - [实战一：基于授权码模式，实现 SSO 单点登录](#实战一基于授权码模式实现-sso-单点登录)
  - [实战二：基于密码模式，实现 SSO 登录](#实战二基于密码模式实现-sso-登录)
- [OAuth 2.0 表结构](#oauth-20-表结构)
...
**原文链接**: https://doc.iocoder.cn/oauth2/

**所属章节**: 后端手册

**爬取时间**: 2026/3/3 15:02:17
