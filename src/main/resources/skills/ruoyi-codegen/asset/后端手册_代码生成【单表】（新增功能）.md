# 代码生成【单表】（新增功能） | ruoyi-vue-pro 开发指南
...
**原文链接**: https://doc.iocoder.cn/new-feature/

**所属章节**: 后端手册

**爬取时间**: 2026/3/3 15:02:04
...
yudao-ui-admin-vben（antd）

Vben5.0 Ant Design Schema 模版

yudao-ui-admin-vben（ele）
